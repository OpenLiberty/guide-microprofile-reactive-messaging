...
Learn how to create a REST microservice with MP-reactive messaging, and Open Liberty.

== What you'll learn

This guide explains MP-reactive messaging concept and demonstrates how to use MP-reactive messaging between microservices using kafka borker.
...
image::reactive-messaging-restaurant.png[Reactive Inventory System,align="center"]
