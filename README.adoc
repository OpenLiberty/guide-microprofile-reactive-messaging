...
To access the `Inventory` microservice, see the http://localhost:9080/inventory/systems[^] URL, and you see the CPU usage properties for all the systems.
...
The `@GET` http://localhost:9080/inventory/system/{hostId}[^] microservice endpoint gives you the CPU usage properties for a particular host.
