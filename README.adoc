...
The `Bar`, `OpenLibertyCafe`, and `ServingWindow` microservices are provided to you. You need to complete the implementation of the `Kitchen` and `Status` microservices in this section.
