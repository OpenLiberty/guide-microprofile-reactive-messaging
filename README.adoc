...
After waiting a while to allow the application completely started, you can access the application by making requests to the `restaurantBFF` endpoint using OpenAPI.
