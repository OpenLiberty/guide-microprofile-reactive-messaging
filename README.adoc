...
=== MicroProfile Reactive Messaging key concepts are as follows :
...
- Configures the server to enable MicroProfile Reactive Messaging. This is specified in the [hotspot=featureMP file=0]`<feature>` element.
