...
public class GatewayInventoryEndpointIT {
    ...
    public void testGetJobs() {
        Response response = (Response) inventoryResource.getJobs();
    ...
    public void testGetSingleJob() {
        Response response = (Response) inventoryResource.getSingleJob("0001");
        assertEquals(200, response.getStatus());
        assertEquals("application/json", response.getHeaderString("Content-Type"));
    }
    ...
    @Test
    @Order(3)
    public void testGetJobsList() {
        Response response = (Response) inventoryResource.getJobsList("0001");
        assertEquals(200, response.getStatus());
        assertEquals("application/json", response.getHeaderString("Content-Type"));
    }
}
